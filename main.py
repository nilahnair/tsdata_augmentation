...
ex= Experiment('lara_imu cnn_trans 50-0.0001-100 trial layer 3')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    epochs = {'mocap': {'cnn': {'softmax': 6, 'attribute': 6},
              ...
              'mbientlab': {'cnn': {'softmax': 10, 'attribute': 10},
                            ...
                            'cnn_transformer':{'softmax': 100, 'attribute': 6}},
    ...
    batch_size_train = {
        ...
        'cnn_transformer': {'mocap': 100, 'mbientlab': 50, 'mobiact': 50, 'motionsense': 100, 'sisfall': 50}}
