...
def my_config():
    ...
    assert dataset in ['mocap', 'mbientlab', 'lara_mm', 'lara_3s',
                       'mobiact', 'motionsense', 'sisfall'], 'Dataset is configured wrong'
    ...
    # num_filters_defaults = {
    #     'mocap': {
    #         'cnn': 64, 'lstm': 64, 'cnn_imu': 64, 'cnn_transformer':64
    #         },
    #     'mbientlab': {
    #         'cnn': 64, 'lstm': 64, 'cnn_imu': 64, 'cnn_transformer':64
    #         },
