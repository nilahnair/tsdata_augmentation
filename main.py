...
ex= Experiment('motionsense cnntrans 200-0.001-15 transt')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    batch_size_train = {
        ...
        'lstm': {'mocap': 100, 'mbientlab': 50, 'mobiact': 100, 'motionsense': 50, 'sisfall': 50},
        'cnn_imu': {'mocap': 100, 'mbientlab': 100, 'mobiact': 100, 'motionsense': 100, 'sisfall': 100},
        'cnn_transformer': {'mocap': 100, 'mbientlab': 100, 'mobiact': 200, 'motionsense': 200, 'sisfall': 100}}
