...
def my_config():
    ...
    assert dataset in ['mocap', 'mbientlab', 'mm', 'mobiact', 'motionsense', 'sisfall'], 'Dataset is configured wrong'
    ...
    dataset_root_defaults = {
        ...
        'mm':           "/vol/actrec/DFG_Project/2019/Motionminers_Dataset/DFG-Data/",
    ...
    NB_sensor_channels_defaults = {'mocap': 126, 'mbientlab': 30, 'mm': 27, 'mobiact': 9, 'motionsense': 9, 'sisfall': 9}
    sliding_window_length_defaults = {'mocap': 200, 'mbientlab': 100, 'mm': 100, 'mobiact': 200, 'motionsense': 200, 'sisfall': 200}
    sliding_window_step_defaults = {'mocap': 25, 'mbientlab': 12, 'mm': 12, 'mobiact': 50, 'motionsense': 25, 'sisfall': 50}
    ...
    balancing_defaults = {'mocap': False, 'mbientlab': False, 'mm': False, 'mobiact': False, 'motionsense': False, 'sisfall': False}
    ...
    epochs_defaults =  \
            {'mocap': {'cnn': {'softmax': 6, 'attribute': 6},
              ...
              'mm': {'cnn': {'softmax': 10, 'attribute': 10},
                            'lstm': {'softmax': 15, 'attribute': 10},
                            'cnn_imu': {'softmax': 30, 'attribute': 10},
                            'cnn_transformer':{'softmax': 50, 'attribute': 6}},
