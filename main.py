...
ex= Experiment('mobiact cnn trial')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    epochs = {'mocap': {'cnn': {'softmax': 6, 'attribute': 6},
              ...
              'mobiact': {'cnn': {'softmax': 30, 'attribute': 50},
                          ...
                          'cnn_transformer':{'softmax': 6, 'attribute': 6}},
              'motionsense': {'cnn': {'softmax': 6, 'attribute': 50},
                             'lstm': {'softmax': 10, 'attribute': 5},
    ...
    # Batch size
    batch_size_train = {
        'cnn': {'mocap': 100, 'mbientlab': 100, 'mobiact': 50, 'motionsense': 100, 'sisfall': 100},
    ...
    batch_size_val = {'cnn': {'mocap': 100, 'mbientlab': 100, 'mobiact': 50, 'motionsense': 100,'sisfall': 100},
                      'lstm': {'mocap': 100, 'mbientlab': 100, 'mobiact': 100, 'motionsense': 100,'sisfall': 100},
                      'cnn_imu': {'mocap': 100, 'mbientlab': 100,'mobiact': 100, 'motionsense': 100,'sisfall': 100},
                      'cnn_transformer': {'mocap': 200, 'mbientlab': 100,'mobiact': 100, 'motionsense': 100,'sisfall': 100}}
