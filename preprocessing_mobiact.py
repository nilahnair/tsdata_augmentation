...
def norm_mobi(data):
    ...
    '''
    mean_values=np.array([ 0.240851623,  7.13644628,  0.373189246, 
                                -0.0232327440, -0.00395112804,  0.0136019672,  
                                179.498688, -67.9060605,  1.90372102])
    std_values=np.array([ 3.4748497,    6.7072082,    3.2804421,    
                                1.11511935,   1.11383806, 0.71638005,
                                 105.66588754,  58.62028255,  17.53491985])
